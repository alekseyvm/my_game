...
3. Вопросы в текстовом файле (формат JSON)
...
4. Отображение наименования предмета в заголовке страницы во время игры
5. Дашборд с итогами текущего раунда
6. Отдельные файлы стилей для оформления
...
├── data/
│   ├── questions.json  # Вопросы для игры (История)
...
- Сканирование папки data для поиска доступных файлов с вопросами (*.json)
...
2. Хранение данных:
   - Вопросы в формате JSON с полем "subject"
   - Поддержка нескольких файлов вопросов в папке data
