...
3. Файл конфигурации (questions.json) содержит список доступных баз вопросов
4. Вопросы в текстовом файле (формат JSON)
...
5. Отображение наименования предмета в заголовке страницы во время игры
6. Дашборд с итогами текущего раунда
7. Отдельные файлы стилей для оформления
